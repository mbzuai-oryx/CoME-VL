...
if __name__ == "__main__":
    ...
    parser.add_argument("--vision_backbone2", choices=list(VISION_BACKBONES.keys()), default=None)
    parser.add_argument("--checkpoint", default=None, help="Path to checkpoint to start from")
    ...
    parser.add_argument("--dataset", default="pixmo_docs_charts")
    ...
    if debug:
        ...
        if args.vision_backbone == "openai":
            vit_layers = [-2, -9]
        elif args.vision_backbone == "dinov3_large_224":
            vit_layers = [-1, -3]
        else:
            vit_layers = [-1]

        if args.vision_backbone2 == "openai":
            vit_layers2 = [-2, -9]
        elif args.vision_backbone2 == "dinov3_large_224":
            vit_layers2 = [-1]
        else:
            vit_layers2 = [-3]
        ...
        model_cfg = replace(
            ...
            vision_backbone2=VISION_BACKBONES[args.vision_backbone2],
            ...
            vit_load_path2=DEFAULT_LOAD_PATHS.get(args.vision_backbone2, omegaconf.MISSING),
    ...
    cfg = TrainConfig(
        ...
        # torch.distributed.fsdp.FullyShardedDataParallel(module, process_group=None, 
